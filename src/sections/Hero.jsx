...
<h1 className='mt-10 font-palanquin text-8xl max-sm:text-[72px]  font-bold leading-12'>
...
{statistics.map((item, index)=> (
    ...
    <div className='relative flex flex-1 justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center'>
        <img src={bigShoeImage} alt='big shoe' width={610} height={600} className='object-contain relative z-10'/>
